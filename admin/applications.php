			...
			<div class="col-lg-8">
				<div class="card">
					<div class="card-header">
						<div class="row">
							<div class="col-lg-12">
								<span><large><b>Applicants List</b></large></span>
								...
								<button class="btn btn-sm btn-block btn-primary btn-sm col-md-4 float-right" type="button" onclick="window.location.href='http://localhost/recruitment-management-system-using-php/admin/stored_procedure.php'" >Delete failed Applicant</button>
							</div>
						</div>
